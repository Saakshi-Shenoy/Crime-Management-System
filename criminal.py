...
class Criminal:
    ...
    def create_officers_tab(self):
        ...
        down_frame=LabelFrame(Main_frame,bd=2,relief=RIDGE,text='Officer Information Table',font=('times new roman',11,'bold'),fg='red',bg='white')
        down_frame.place(x=10,y=10,width=1480,height=270)

        search_frame=LabelFrame(down_frame,bd=2,relief=RIDGE,text='Search Officer',font=('times new roman',11,'bold'),fg='red',bg='white')
        search_frame.place(x=0,y=0,width=1470,height=60)
