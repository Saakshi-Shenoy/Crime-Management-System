...
class Criminal:
    def __init__(self,root):
        ...
        lbl_title=Label(self.root,text='CRIMINAL MANAGEMENT SYSTEM SOFTWARE',font=('palatino',35,'bold'),bg='black',fg='gold')
    ...
    def create_criminal_tab(self):
        ...
        caseentry=ttk.Entry(upper_frame, width=22,font=('palatino',11,'bold'))
        ...
        txt_lastName=ttk.Entry(upper_frame,width=22,font=('palatino',11,'bold'))
        ...
        txt_dob=ttk.Entry(upper_frame,width=22,font=('palatino',11,'bold'))
        ...
        txt_gender=ttk.Entry(upper_frame,width=22,font=('palatino',11,'bold'))
        ...
        txt_nationality=ttk.Entry(upper_frame,width=22,font=('palatino',11,'bold'))
        ...
        txt_address=ttk.Entry(upper_frame,width=22,font=('palatino',11,'bold'))
        ...
        txt_criminalID=ttk.Entry(upper_frame,width=22,font=('palatino',11,'bold'))
        txt_criminalID.grid(row=2,column=1,sticky=W,padx=2,pady=7)

        #Prison-id
        lbl_dateofCrime=Label(upper_frame,font=('palatino',12,'bold'),text="Prison_ID:",bg='white')
        lbl_dateofCrime.grid(row=2,column=2,sticky=W,padx=2,pady=7)

        txt_dateofCrime=ttk.Entry(upper_frame, width=22,font=('palatino',11,'bold'))
        ...
        txt_status=ttk.Entry(upper_frame,width=22,font=('palatino',11,'bold'))
        ...
        btn_add = Button(button_frame, text='Save', font=('times new roman', 13, 'bold'), width=14, bg='blue', fg='white')
        btn_add.grid(row=0, column=0, padx=3, pady=5)
        
        btn_update=Button(button_frame,text='Update',font=('times new roman',13,'bold'),width=14,bg='blue',fg='white')
        ...
        #Clear Button
        btn_clear=Button(button_frame,text='Clear',font=('times new roman',13,'bold'),width=14,bg='blue',fg='white')
        ...
        combo_search_box=ttk.Combobox(search_frame,font=("palatino",11,"bold"),width=18,state='readonly')
        ...
        #search button
        btn_search=Button(search_frame,text='Search',font=("palatino",13,"bold"),width=14,bg='blue')
        btn_search.grid(row=0,column=3,padx=3,pady=5)

        #all button
        btn_all=Button(search_frame,text='Show All',font=("palatino",13,"bold"),width=14,bg='blue')
    ...
    def create_case_tab(self):
        ...
        txt_sDate=ttk.Entry(upper_frame,width=22,font=('palatino',11,'bold'))
        ...
        txt_eDate=ttk.Entry(upper_frame,width=22,font=('palatino',11,'bold'))
        ...
        txt_judge=ttk.Entry(upper_frame,width=22,font=('palatino',11,'bold'))
        ...
        txt_verdict=ttk.Entry(upper_frame,width=22,font=('palatino',11,'bold'))
        ...
        txt_crimeid=ttk.Entry(upper_frame, width=22,font=('palatino',11,'bold'))
    ...
    def create_crimes_tab(self):
        ...
        txt_cname=ttk.Entry(upper_frame,width=22,font=('palatino',11,'bold'))
        ...
        txt_cdesc=ttk.Entry(upper_frame,width=22,font=('palatino',11,'bold'))
        ...
        txt_severity=ttk.Entry(upper_frame,width=22,font=('palatino',11,'bold'))
        ...
        txt_datecom=ttk.Entry(upper_frame,width=22,font=('palatino',11,'bold'))
        ...
        txt_location=ttk.Entry(upper_frame,width=22,font=('palatino',11,'bold'))
        ...
        txt_incharge=ttk.Entry(upper_frame, width=22,font=('palatino',11,'bold'))
        ...
        #search button
        btn_search=Button(search_frame,text='Search',font=("times new roman",13,"bold"),width=14,bg='blue')
        btn_search.grid(row=0,column=3,padx=3,pady=5)

        #all button
        btn_all=Button(search_frame,text='Show All',font=("times new roman",13,"bold"),width=14,bg='blue')
        btn_all.grid(row=0,column=4,padx=3,pady=5)
    ...
    def create_officers_tab(self):
        ...
        self.criminal_table.heading("1",text="officer_id")
        self.criminal_table.heading("2",text="first_name")
        self.criminal_table.heading("3",text="last_name")
        self.criminal_table.heading("4",text="badge_number")
        self.criminal_table.heading("5",text="rank_level")
        self.criminal_table.heading("6",text="department")
        self.criminal_table.heading("7",text="contact_info")
